...
const ShoppingCartItem = ({ produs }) => {
	...
	return (
		<View
			style={{ padding: 10, borderWidth: 3, borderRadius: 20, marginTop: 10 }}
		>
			<View style={{ flexDirection: 'row' }}>
				...
				<View>
					...
					<Text style={{ fontSize: 14 }}>{produs.descriere}</Text>
			...
			<View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
				...
				<TouchableOpacity onPress={() => removeFromShoppingCart(produs.id)}>
